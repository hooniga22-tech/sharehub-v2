          ...
          {manageMenus.operation.map((menu, i) => {
            ...
            return (
              <div key={menu.slug}>
                ...
                <Link href={menu.slug === 'applications' ? '/apply' : menu.slug === 'worker' ? '/workers' : menu.slug === 'investors' ? '/investors' : `/manage/${menu.slug}`} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px' }}>
